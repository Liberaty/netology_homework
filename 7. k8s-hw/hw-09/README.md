...
![1.1.img](https://github.com/Liberaty/netology_homework/blob/main/7.%20k8s-hw/hw-09/img/1.1.png?raw=true)
...
![2.1.img](https://github.com/Liberaty/netology_homework/blob/main/7.%20k8s-hw/hw-09/img/2.1.png?raw=true)

- Добавляем контекст командой ```kubectl config set-context alepishin-context --cluster=microk8s-cluster --user=alepishin```
![2.2.img](https://github.com/Liberaty/netology_homework/blob/main/7.%20k8s-hw/hw-09/img/2.2.png?raw=true)
...
![2.3.img](https://github.com/Liberaty/netology_homework/blob/main/7.%20k8s-hw/hw-09/img/2.3.png?raw=true)

3. Создайте роли и все необходимые настройки для пользователя.
#
***Ответ***

- Создаем [**role.yaml**](https://github.com/Liberaty/netology_homework/blob/main/7.%20k8s-hw/hw-09/role.yaml) и [**rolebinding.yaml**](https://github.com/Liberaty/netology_homework/blob/main/7.%20k8s-hw/hw-09/rolebinding.yaml) для пользователя и применяем их.

![3.1.img](https://github.com/Liberaty/netology_homework/blob/main/7.%20k8s-hw/hw-09/img/3.1.png?raw=true)
...
![4.1.img](https://github.com/Liberaty/netology_homework/blob/main/7.%20k8s-hw/hw-09/img/4.1.png?raw=true)
